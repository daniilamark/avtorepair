...
class SQLHelper {
  ...
  static Future<int> createdUser(String name, String? surname) async {
    final db = await SQLHelper.db();

    final user = {'name': name, 'surname': surname};
  ...
  static Future<int> updateUser(int id, String name, String? surname) async {
    final db = await SQLHelper.db();
